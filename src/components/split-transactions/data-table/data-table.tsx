...
export const splitTransactionFormSchema = splitTransactionSchema
  .extend({
    amount: z.preprocess(
...
export function SplitTransactionsTable({
  transactions,
  transactionId,
  totalAmount,
  tags,
  ...
  const handleSubmit = form.handleSubmit(
    (data: SplitTransactionsTableFormProps) => {
      ...
      <Form {...form}>
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex p-4">
            ...
            <Label className="pl-2">{remainingAmount?.toFixed(2) ?? 0.0}</Label>
          </div>
