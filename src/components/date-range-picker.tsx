            ...
            footer={
              <div className={cn('pt-3', className)}>
                <div className="flex flex-wrap justify-between pb-2">
                  <Link
                    onClick={() =>
                      handleDateChange({ from: new Date(), to: new Date() })
                    }
                    to="."
                  ...
                  <Link
                    onClick={() => handleDateChange(getMonthDateRange())}
                    to="."
                    className={badgeVariants({ variant: 'outline' })}
                  >
                    This Month
                  ...
                  <Link
                    onClick={() => handleDateChange(getMonthDateRange(1))}
                    to="."
                    className={badgeVariants({ variant: 'outline' })}
                  >
                    Last Month
                  ...
                  <Link
                    onClick={() => handleDateChange(getYearDateRange())}
                    to="."
                    className={badgeVariants({ variant: 'outline' })}
                  >
                    This Year
                  ...
                  <Link
                    onClick={() => handleDateChange(getYearDateRange(1))}
                    to="."
                    className={badgeVariants({ variant: 'outline' })}
                  >
                    Last Year
                ...
                <div className="flex flex-wrap gap-2">
                  <Link
                    onClick={() => handleDateChange(getLastMonthsDateRange(3))}
                    to="."
                    className={badgeVariants({ variant: 'outline' })}
                  >
                    Last 3 Months
                  ...
                  <Link
                    onClick={() => handleDateChange(getLastMonthsDateRange(6))}
                    to="."
                    className={badgeVariants({ variant: 'outline' })}
                  >
                    Last 6 Months
                  ...
                  <Link
                    onClick={() => handleDateChange(getLastMonthsDateRange(12))}
                    to="."
                    className={badgeVariants({ variant: 'outline' })}
                  >
                    Last 12 Months
...
function getLastMonthsDateRange(numberOfMonths: number): {
  from: Date
  to: Date
} {
  const today: Date = new Date()
